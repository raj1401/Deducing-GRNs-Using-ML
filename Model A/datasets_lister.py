...
# Saving these indices so that the datasets can be remapped in the future
np.savetxt(os.path.join("ODE Solver","mono_indices.txt"),monoargs)
np.savetxt(os.path.join("ODE Solver","bi_indices.txt"),biargs)
